...
- Когда счётчик достигнет 0, должно отображаться сообщение с эмоджи ракеты "🚀" и таймер должен быть остановлен. Пользователь видит: 3 -> 2 -> 1 -> 🚀
...
Подсказки:
- 🧙‍♂️ В этом задании ты должен познакомиться с браузерными функциями setInterval (https://doka.guide/js/setinterval/) и clearInterval(https://doka.guide/js/clearinterval/). Они очень похоже на setTimeout и clearTimeout.
 */

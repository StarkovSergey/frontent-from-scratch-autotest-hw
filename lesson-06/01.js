/*
- Добавьте функциональность к кнопкам "prev" и "next", чтобы при их нажатии изображение в теге `<img>` менялось на предыдущее или следующее в массиве соответственно.

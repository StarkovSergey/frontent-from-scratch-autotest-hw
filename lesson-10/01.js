...
2. Добавить обработчик события для удаления фильмов:
  ...
  - при клике на кнопку удаления, получить id фильма и передать его в метод deleteMovie объекта controller
...
//       view.displayMessage('Фильм добавлен успешно!', false)
//     } else {
...
const controller = {
  ...
  deleteMovie(id) {
    ...
    view.displayMessage('Фильм успешно удалён!', false)
  },
}
